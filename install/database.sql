...
CREATE TABLE `{prefix}member` (
  `id_m` int(2) NOT NULL COMMENT 'ลำดับ',
...
CREATE TABLE `{prefix}question` (
  `qid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ลําดับคําถาม',
  `qdate` date NOT NULL COMMENT 'วันที่',
  `q` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'คําถาม',
  `id_m` int(3) NOT NULL COMMENT 'ผู้ถาม',
  PRIMARY KEY (`qid`)
